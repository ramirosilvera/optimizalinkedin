      ...
      <div className="w-full max-w-sm rounded-3xl overflow-hidden"
        ...
        <div className="p-6 space-y-5 bg-white">
          <ul className="space-y-3">
            {[
              ['🗂️', 'Historial completo guardado', 'Diagnóstico, CV, entrevistas y STAR — todo persistente entre sesiones'],
              ['📄', 'CV re-descargable cuando quieras', 'Generá versiones y descargalas en cualquier momento, sin rehacer el proceso'],
              ['🎙️', 'Entrenador de entrevistas acumulativo', 'Tu feedback se acumula sesión a sesión — mejorás de forma medible'],
              ['📍', 'Seguimiento de postulaciones', 'Kanban visual para gestionar cada proceso activo en paralelo'],
            ].map(([icon, title, desc]) => (
          ...
          <p className="text-center text-xs text-slate-400 -mt-1">
            La versión gratuita sigue siendo completa. Premium agrega persistencia e historial.
          </p>
